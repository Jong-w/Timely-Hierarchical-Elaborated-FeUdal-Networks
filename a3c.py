...
def feudal_loss(storage, next_v_m, next_v_w, args):
    ...
    advantage_w = ret_w - value_w  #todo: before= 'ret_w - value_w + args.alpha * rewards_intrinsic'  <- we removed intrinsic reward from it
    ...
    loss = (value_w_loss - loss_worker) - args.entropy_coef * entropy #todo: remove things about manager
