...
from meltingpotnet_with_same_length_state_s import MPnets, mp_loss
    ...
    while step < args.max_steps:
        ...
        for _ in range(args.num_steps):
            ...
            storage.add({
                ...
                'g_goal_cos': MPnet.goal_goal_cosine(goals_m, states_s, masks), #TODO changed goals_s to states_s (same with model code)
                'm': mask
            })
